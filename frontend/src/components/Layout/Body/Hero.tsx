        ...
        <div className="grid max-w-lg grid-cols-1 mx-auto lg:max-w-full lg:items-center lg:grid-cols-2 gap-y-12 lg:gap-x-16">
          <div>
            <div className="text-center lg:text-left">
              ...
              <button className=" px-6 py-3 mt-6 text-lg font-bold text-white transition-all duration-200 bg-gray-900 rounded-lg focus:outline-none focus:bg-gray-600 font-pj hover:bg-gray-600">
                Book a Demo
              </button>
              <button className=" px-6 py-3 mt-6 mx-6 text-lg font-bold text-white transition-all duration-200 bg-zinc-600 rounded-lg focus:outline-none focus:bg-gray-600 font-pj hover:bg-gray-600">
                Explore Kant AI
              </button>
            </div>
